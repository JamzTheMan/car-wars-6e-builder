...
export function DeckLayoutMenu() {
  ...
  const [division, setDivision] = useState(Math.ceil((currentDeck?.pointLimits.crewPoints ?? 0) / 4));
        ...
        <div className="absolute right-0 mt-2 w-64 bg-gray-800 rounded-lg shadow-xl border border-gray-700 z-50">
          <div className="p-4 space-y-4">
            <div className="flex items-center justify-between border-b border-gray-700 pb-2">
              ...
              <button
                onClick={() => {
                  if (confirm("Are you sure you want to reset the car? This will remove all cards and reset point costs to zero.")) {
