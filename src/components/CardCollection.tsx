...
export function CardCollection() {
  ...
  return (
    <div ref={drop} className="p-2 h-full relative">
      ...
      <div className="mb-4">
        ...
        {filterPanelOpen && (
          <div className="flex flex-col space-y-3 p-3 bg-gray-800 rounded border border-gray-700 mb-3">
            <h3 className="text-sm font-medium border-b border-gray-700 pb-1 mb-2">
              Filter Collection
            </h3>
      ...
      <div
        className={`grid gap-x-1 gap-y-2 grid-cols-[repeat(auto-fit,minmax(125px,1fr))] ${isUploading ? 'opacity-50' : ''}`}
      >
        {cards.length > 0 ? (
